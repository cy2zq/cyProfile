...
$(function () {
  ...
  $("#page-indicator [data-rel], #J_Header [data-rel]").click(function () {
    ...
    if (!pageTransition) goToPage(targetPage, "fade");
    return false;
  });
  // 创建carousel2实例
  ...
  (function () {
    ...
    pageReverts[2] = function () {
      ...
      $page2layers.each(function (idx, item) {
        idx++;
        $(item).removeClass(
          "layer" + idx + "-ignore layer" + idx + "-active active"
        );
      });
    };
    // }
  ...
  (function () {
    ...
    pageEvents[7] = function () {
      ...
      var infoWindow = new BMap.InfoWindow(
        "地址：南京市江宁区将军大道迎翠路7号千人科技创业大厦4005 <br /> 电话：025-84189011",
        opts
      ); // 创建信息窗口对象
